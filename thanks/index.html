  ...
  <div class="clearfix">
    ...
    <nav>
      <ul>
		...
		<li><a href="/newsletter" class="cc-active">Newsletter</a></li>
...
<section>
	<div class="container subheader">
		<h2 class="editable">Thank you!</h2>
		<p style="color: #000000;" class="editable">From now on, you'll receive regular updates on everything Whonix.</p>
	</div>
</section>
		...
		<div class="quad clearfix">
			<div>
				<div class="portfolio-block">
					<a href="/wiki/VirtualBox"><img width="350" height="200" src="/img/win10.png" alt="Windows" class="editable"></a>
