	...
	<div class="container">
		<div class="left-column">
			...
			<div class="staff-profile">
				<h4 class="editable">Multiple Browsers/Gateways/Workstations</h4>
				<p>Insert Text</p>
			</div>

			<div class="staff-profile">
				<h4 class="editable">Tunnels</h4>
				<p>Insert Text</p>
			</div>

			<div class="staff-profile">
				<h4 class="editable">Other Applications</h4>
				<p>Insert Text</p>
			</div>

			<div class="staff-profile">
				<h4 class="editable">Hardened Configurations</h4>
				<p>Insert Text</p>
			</div>

			<div class="staff-profile">
				<a href="/anonymity" class="button">< Back</a>
			</div>
