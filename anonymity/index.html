...
<section class="alternate-section">
	<div class="container">
		<div class="left-column">
			<h3>Preserving your Privacy</h3>

			<div class="staff-profile">
				<h4 class="editable">What to do</h4>
				<p>Insert Text</p>
			</div>

			<div class="staff-profile">
				<h4 class="editable">What not to do</h4>
				<p>Insert Text</p>
			</div>

			<div class="staff-profile">
				<a href="/common" class="button">< Back</a>
				<a href="/more" class="button">Next ></a>
			</div>
