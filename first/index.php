...
<section class="alternate-section">
	<div class="container">
		<div class="left-column">
			<h3>First Steps in Whonix</h3>

			<div class="staff-profile">
				<h4 class="editable">Launch, connect</h4>
				<p>Insert Text</p>
			</div>

			<div class="staff-profile">
				<h4 class="editable">Browse the Web</h4>
				<p>Insert Text</p>
			</div>

			<div class="staff-profile">
				<a href="/install" class="button">< Back</a>
				<a href="/common" class="button">Next ></a>
			</div>
