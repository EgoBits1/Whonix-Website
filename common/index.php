	...
	<div class="container">
		<div class="left-column">
			...
			<div class="staff-profile">
				<h4 class="editable">Pre-Installed Applications</h4>
				<p>Insert Text</p>
			</div>

			<div class="staff-profile">
				<h4 class="editable">Need something else?</h4>
				<p>Insert Text</p>
			</div>

			<div class="staff-profile">
				<a href="/first" class="button">< Back</a>
				<a href="/anonymity" class="button">Next ></a>
			</div>
